...
class EventConstants {
  ...
  static const int CHECK_SUCCESSFUL = 400;
  static const int CHECK_ERR = 401;
  static const int CHANGE_SUCCESSFUL = 500;
  static const int CHANGE_ERR = 501;
  static const int INVALID_OLD_PASS = 502;
  static const int FEED_SUCCESSFUL = 600;
  static const int FEED_ERR = 601;
}
